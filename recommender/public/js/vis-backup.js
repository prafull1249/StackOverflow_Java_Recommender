(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data.main) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["k1", "k2", "k3"]).range(["#003F87", "#0075FB", "#71B3FF"]);
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d.id,
            radius: _this.radius_scale(parseInt(d.weight)),
            value: d.weight,
            name: d.title,
            org: d.text,
            group: d.keywords,
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content += "<span class=\"name\">Keyword:</span><span class=\"value\"> " + data.year + "</span>";
